  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 sm:px-6">
      <form
        ...
        className="shadow-2xl rounded-2xl p-6 sm:p-8 w-full max-w-md space-y-6 bg-white"
      >
        <h2 className="text-2xl font-bold text-black text-center">Create Company</h2>
        ...
        <div>
          <label className="block mb-1 text-sm font-semibold text-black">Description</label>
          <input
            type="text"
            value={desc}
